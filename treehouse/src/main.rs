...
struct Visitor {
    ...
    age: i8, // 8-bit signed integer (from -128 to 127)
}
...
fn main() {
    let mut visitor_list = vec![
        Visitor::new("kinu", VisitorAction::Accept, 29),
        Visitor::new("mugi", VisitorAction::Accept, 29),
        Visitor::new(
            "Ayumi",
        ...
        Visitor::new("herbert", VisitorAction::Refuse, 45),
    ];
